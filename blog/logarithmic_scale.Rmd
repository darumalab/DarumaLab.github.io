...
# new_content(paste0("blog/test-", Sys.Date(), ".Rmd"))
# tags: ["チャート-charts","対数-log","線形-linear"]
...
1885年の秋のある日、アーサー・コナン・ドイルは株式仲買店員の友人に稼ぎの一部を預けることにした。大学卒業後、開業した診療所の仕事がやっと軌道に乗りはじめていた。経済的に困っていたわけではなく、資金繰りが苦しい友人を助けるつもりだった。預けたソブリン金貨には複利の利子がつく。「金貨は必ず毎年0.5倍ずつ増えていく」
