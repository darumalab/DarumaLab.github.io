...
大麦は毎年同じ増加率を達成していた。リスは銀行に渡された対数目盛のチャートを見てとても満足した。一方の軸が対数目盛になっているグラフを片対数(semi-log)チャートと呼ぶ。^[[片対数グラフ](https://ja.wikipedia.org/wiki/%E7%89%87%E5%AF%BE%E6%95%B0%E3%82%B0%E3%83%A9%E3%83%95)]片対数チャートを見ると増加傾向は毎年同じ比率を保っていることが分かる。
