...
[RStudio](https://www.rstudio.com/)は[R言語](https://cran.r-project.org/)のオープンソース^[[開発コードはGithubで公開されています](https://github.com/rstudio)]のIDE（統合開発環境）のことで、R言語を使ったプログラミングに欠かせないソフトウェアです。こRStudioを使うメリットとは何でしょうか？

### RStudioを使うメリット

1. プログラミングに使うコード、データ、データ分析の結果をプロジェクトごとに管理できる
2. データ分析をアシストする多彩な機能が使える。例えばプロットのウィンドでは、チャートやグラフのサイズを手軽に調整したり、ファイル形式を指定して保存することができる。（jpg/png/pdf/svg/postscript/png/...）その他にもデータの読み込み、[バージョンコントロール](https://support.rstudio.com/hc/en-us/articles/200532077-Version-Control-with-Git-and-SVN)のアシスタント機能などがある
